window.SINGLE_TAB = "  ";
	window.ImgCollapsed = "http://tool.oschina.net/tools/json_format/Collapsed.gif";
	window.ImgExpanded = "http://tool.oschina.net/tools/json_format/Expanded.gif";
	...
	function Process(json,outputid){
	  SetTab();
	  ...
	  try{
	    ...
	    $id(outputid).innerHTML = "<PRE class='CodeContainer'>"+html+"</PRE>";
	  }catch(e){
	    alert("JSON数据格式不正确:\n"+e.message);
	    $id(outputid).innerHTML = json;
	  }
	}
