...
//		Session session = Session.getDefaultInstance(props, null);
		...
		try {
			...
			while (efile.hasMoreElements()) {
				...
				FileDataSource fds = new FileDataSource(FileUtil.getFile(filename));
...
//			}
	 ...
	 */
 	public static void main(String[] args) {
 		...
 		sendmail.setUserName("xxx@163.com");
 		sendmail.setFrom("xxx@163.com");
 		sendmail.setPassWord("yyang810");
 		sendmail.setTo("xxx@xxx.com");
		...
		// Mail("dujiang@sricnet.com","du_jiang@sohu.com","smtp.sohu.com","du_jiang","31415926","你好","胃，你好吗？");
 		sendmail.attachfile("D:\\apache-tomcat8\\apache-tomcat-8.0.32\\webapps\\springplus\\resource\\files\\测试excel报表_20170407164505.xlsx");
 		sendmail.attachfile("D:\\apache-tomcat8\\apache-tomcat-8.0.32\\webapps\\springplus\\resource\\files\\测试excel报表_20170407165144.xlsx");
